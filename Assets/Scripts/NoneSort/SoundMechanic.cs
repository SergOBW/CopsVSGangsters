...
public class SoundMechanic : GlobalMechanic
{
    public static SoundMechanic Instance;
    ...
    {
        volume = SaveManagerMechanic.Instance.GetSoundValue();
    ...
    public void OnSound()
    {
        ...
        volume = 1;
        mainMixer.SetFloat(MASTER_VOLUME_NAME,volume);
        SaveManagerMechanic.Instance.SaveSound(volume);
    }
