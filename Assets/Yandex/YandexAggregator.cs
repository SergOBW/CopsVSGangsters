...
public class YandexAggregator : MonoBehaviour
{
    ...
    public void SaveDataToStorage(PlayerSaves playerSaves)
    {
        ...
        if (LoginManager.Instance.isLogin)
        {
            string jsonString = JsonConvert.SerializeObject(playerSaves);
    ...
    {
        SaveManagerMechanic.Instance.SetPlayerInfo(json);
    }
