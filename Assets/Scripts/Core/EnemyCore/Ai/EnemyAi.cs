...
{ 
    ...
    internal class EnemyAi : MonoBehaviour
    {
        ...
        public void Initialize(AiStats aiStats,float _defaultSpeed, bool withEndPoint, float _maxSpeed)
        {
            currentAiStats = aiStats;
            CreateScripts();
            
            _sensor.Initialize(new FovContainer(currentAiStats.radius,currentAiStats.angle,
            ...
            if (withEndPoint)
            {
                GameObject endPointGameObject = GameObject.FindWithTag("Player");
        ...
        private void CreateScripts()
        {
            ...
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                {
                    _sensor = child.AddComponent<Sensor>();
                    break;
                }
            }
        }
